...
MAKEFILE=../../../$OUTDIR/$DEVICE-vendor-files.mk
...
\$(call inherit-product, vendor/$VENDOR/$DEVICE/$DEVICE-vendor-files.mk)
EOF
...
echo " $OUTDIR/proprietary/lib/hw/audio.r_submix.mt6589.so:system/lib/hw/audio.r_submix.mt6589.so \\" >> $MAKEFILE
echo " $OUTDIR/proprietary/lib/hw/audio.usb.mt6589.so:system/lib/hw/audio.usb.mt6589.so \\" >> $MAKEFILE
echo "" >> $MAKEFILE
